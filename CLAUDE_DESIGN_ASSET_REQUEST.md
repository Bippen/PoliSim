...
<!-- GENERATED by D18Inventory.Emit (Tools/d18_inventory.sh). DO NOT EDIT BY HAND. source-digest: 6f8dbb958ca7e3a214146e292ad1d5424ea86eb398aa2e3c09625518ce819c02 -->
...
```
  MISSING   icon_area_energy does not resolve through IconLibrary.GetAreaIcon
=== Area icons: 10 of 11 resolve (SystemArea members as RGBA32), 1 missing, 0 damaged ===
```
...
*197 sprite(s) under `Assets/Resources/Art/UI/`. A file counts as REACHED when an
...
**The runs behind this block**: PartyMark 0 · Portrait 0 · StatIcon 0 · AreaIcon 1 · AudioCue 0 — 0 is a clean check; a non-zero code means that family's own bar is red and this
