...
- **PF-5 — four bill call-to-action buttons still wear the retired pack's face.** OPEN, found 2026-09-21 (`COMPLETED.md` §550) while fixing Design's sighting on the Energy tab's: the Labor Market, Trade, Emergency Drawdown and Budget bills each draw their own full-width button where board 6a draws one width in the family's column. The Energy tab's is re-cut; the four siblings are the same fix on four call sites, its own UI item.
