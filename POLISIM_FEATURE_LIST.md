...
| **FT-6, the NAIRU half** (§379, §385) | the expectations half is applied (§385, forgotten toward the target); what stays measured is the persistent tenth of a point below NAIRU, whose mechanism is FT-7's | the unemployment gap reading the supply side |
| **FT-7, the second seat** (§383, §389, §391) | the first seat is landed (unemployment reads the change in participation, absorbed at SELMA's rate); what stays is potential reading employment rather than participation at NAIRU - six seed potentials re-solved, B7's family reopened | a supply rise reaching potential only as it is employed; FT-5's landing in the target |
