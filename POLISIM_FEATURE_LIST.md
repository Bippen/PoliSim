...
| **SC-1** (§498) | which line the sector dials' support cost lands on in the five statute budgets, and whether the clamp's rule changes for a dial cost | the Sectors page's cost booked in five countries |
