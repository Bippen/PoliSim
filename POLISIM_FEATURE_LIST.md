...
| **The AI finance ministry** (§384) | under the law's indexation the AI states' caseload lines outgrow their economies with their pensioners, and no AI state takes a fiscal decision in answer - a design call on whether it should, and what it reads | the AI countries' debt paths over a century, which the player sees |
