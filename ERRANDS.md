...
| **E-8** | **The nine Playtest 3 screenshots and `PLAYTEST3_ROWS.md`** - named by the sheet (images 1, 7, 8, 9 bound to rows P3-B1, P3-B2, P3-D1) but not attached and not on disk; drop them in `G:UNITYProjectsPoliSim-capturesplaytest3` or the repo root. | **D12's annex (the nine verbatim), the image-matching in P3-B1/B2 and the map ask in D12 row 1** | 2026-09-03 |
