...
# customer class in the seed year, DERIVED from the files on disk - never typed. Every input is a file ENERGY_LAYER_SPINE.md §15 lists by digest
...
print $o "# electricity_tax_2023.csv - GENERATED by Tools/energy_tax_prep.pl (EN-7b sourcing). The statutory electricity tax per country and class, 2023, from the files ENERGY_LAYER_SPINE.md §15 lists by digest.\n";
