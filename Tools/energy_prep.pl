...
#
# Stage 2 of the energy track (docs/specs/ENERGY_SPEC.md, ruled §454; docs/data/ENERGY_LAYER_SPINE.md §455): the physical layer's
...
# World Bank SP.POP.TOTL 2023, millions - the divisor of the family's per-head seeds (docs/data/SOCIETY_STATS.md:7).
...
}
{
    ...
    print $o "# fleet_2023.csv - GENERATED by Tools/energy_prep.pl from PoliSim-captures/sources/energy (docs/data/ENERGY_LAYER_SPINE.md §1-§2). Do not edit by hand.\n";
...
}
{
    ...
    print $o "# load_blocks_2023.csv - GENERATED by Tools/energy_prep.pl (docs/data/ENERGY_LAYER_SPINE.md §3). The spec-let's S3 fold: base = the minimum every hour; peak = the periods above the P90 value (the value exceeded by ten per cent of them), at their mean; mid = the rest.\n";
    ...
    print $z "# zones_2023.csv - GENERATED by Tools/energy_prep.pl (docs/data/ENERGY_LAYER_SPINE.md §4). eSett Open Data 2023: EXP15 settlement consumption and EXP16 settlement production by type per market balance area, GWh. thermal is eSett's own class; other = energyStorage + other.\n";
...
}
{
    ...
    print $o "# combustion_2023.csv - GENERATED by Tools/energy_prep.pl (docs/data/ENERGY_LAYER_SPINE.md §9). CO2 of the fossil fuel burned for electricity and heat, 2023, kt, by the family's label (coal = solid fossil fuels; gas = natural gas; other = manufactured gases, oil products, peat, oil shale, non-renewable wastes) and plant class.\n";
    ...
    print $c "# country_2023.csv - GENERATED by Tools/energy_prep.pl. population_m = World Bank SP.POP.TOTL 2023, millions (the divisor of EnvironmentSeeds' per-head figures, docs/data/SOCIETY_STATS.md:7);\n";
