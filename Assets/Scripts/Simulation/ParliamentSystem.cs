...
namespace PoliSim.Simulation
{
    ...
    public static class ParliamentSystem
    {
        ...
        public static float GetLawBillDirection(Country country, LawBill bill)
        {
            ...
            foreach (StructuralDelta structural in law.Structural)
            {
                // P4-C3: a structural effect's sign does not tell a law's politics; the law's own reading does (interventionist = positive here).
                direction += sign * -law.LrEconToward10 * StructuralParameters.GridPoints(structural);
            }
