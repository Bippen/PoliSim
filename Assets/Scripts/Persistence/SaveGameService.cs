...
namespace PoliSim.Persistence
{
    ...
    public static class SaveGameService
    {
        ...
        public const int CurrentSaveVersion = 25;   // 25: PS-1 (2026-09-25, §618) - the save carries its epoch (the chosen country's start); a v24 save has none and would restore its clock against whatever epoch the process holds   // 24: K-1 part (3) (2026-09-24, §604) - the epoch is 1 October 2026; a v23 save's date and turn were cut against 1 January, so its turn boundaries, election date and calendar year would read wrong under the new epoch
