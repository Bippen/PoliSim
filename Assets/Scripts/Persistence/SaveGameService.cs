...
namespace PoliSim.Persistence
{
    ...
    public static class SaveGameService
    {
        ...
        public const int CurrentSaveVersion = 23;   // 23: K-1 part (1) (2026-09-23) - the seeded chamber is the Riksdag elected 2026-09-13; a v22 save embeds the 2022 chamber and its capital baselines, which the loader would keep (ParliamentSystem only fills an empty chamber) - a different game
