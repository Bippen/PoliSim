...
namespace PoliSim.EditorTools
{
    ...
    public static class CheckSuite
    {
        ...
        private static readonly (string Name, Action Run)[] Simulation = new (string Name, Action Run)[]
        {
                ...
                ("InfrastructureFeedbackDiagnostic", InfrastructureFeedbackDiagnostic.Run),   // the infrastructure feedback pass (2026-09-07): zero at the seed, both directions, inside the channel's ceiling
