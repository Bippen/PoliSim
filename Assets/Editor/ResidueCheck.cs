...
namespace PoliSim.EditorTools
{
    ...
    public static class ResidueCheck
    {
        ...
        private static readonly (string Name, string Owner, string Reason)[] Excluded =
        {
            ...
            ("T-3", "OWNER ELIAS", "the identity's government-consumption block - RULED form A and LANDED (§506, §507); its impact reading RULED and the ratchet re-based on the k sweep's continuous curve (§512)"),
            ("P-N5b", "OWNER ELIAS", "Okun on the output gap - RULED (d) HOLD (§513): the growth form stays, the reason the circularity of a gap built on employment; FT-7's formula stands; the next pass opens with (a), the identity anchored to potential - a macro-core family, started by instruction"),
