...
namespace PoliSim.EditorTools
{
    ...
    public static class ReviewLedgerCheck
    {
        ...
        /// </summary>
        public const int GrandfatheredCeiling = 20;   // 21 -> 20 (s632): AiFinanceMinistry moved on (reviewed s632). 22 -> 21 (s626): TaxSchedule.cs reviewed under s626. 26 -> 22 (s590): BudgetBill, PensionAgeStatute, PensionPayment and SpendingDrivers reviewed with PN-1's dial
