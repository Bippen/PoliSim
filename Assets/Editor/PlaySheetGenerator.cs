...
{
    /// <summary>
    /// CL-3 (2026-09-16, §523; the plan's S-C3): **THE PLAY SHEET, GENERATED.** `docs/play/PLAY_SHEET.md` at the repo root is the twenty entries of the
    ...
    {
        public const string SheetRelative = "docs/play/PLAY_SHEET.md";   // s579: the play documents live under docs/play/
