...
namespace PoliSim.EditorTools
{
    ...
    public static class ConstantProvenanceCheck
    {
        ...
        /// built - ⚠ Built at **212 of 285 on 2026-08-31**, reported as a BACKLOG rather than a failure; **lowered in steps to ZERO on 2026-09-01** across seventeen ratchet batches: every constant on the simulation path now says where it came from, so a NEW unmarked one fails rather than joining a backlog.
        ...
        /// </summary>
        private const int UnmarkedCeiling = 0;
