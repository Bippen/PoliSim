...
namespace PoliSim.EditorTools
{
    ...
    public static class SaveLoadRoundTripDiagnostic
    {
        ...
        private static void IntroduceCoverageBills(SimulationManager sim, World world, CountryId player, Country playerCountry)
        {
            ...
            // the round trip proves the twelve-field DialDeltas shape and, since P4-C3, the structural table (hartz_benefit_reform_act and constitutional_debt_brake_act cross too) and the two-book labor
