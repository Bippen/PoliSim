...
| **The sector dials' cost (P4-B3)** | Energy's dials would now cost through the ledgers | reconciled at stage 5 (EN-7a, §498): the Energy subsidy's cost is the energy line's move, the figure the Sectors screen prints is what the line carries; SC-1 - the other dials' cost lands on no line in five books - is ruling-first |
