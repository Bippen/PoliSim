...
| population by age and sex, per municipality | SCB PxWeb `START/BE/BE0101/BE0101A/BefolkningNy`. ⚠ **Metadata endpoint fetched and confirmed at C-D1**: variables `Region · Civilstand · Alder · Kon · ContentsCode · Tid`, with municipality-level `Region` values present | ✅ confirmed to exist with the right dimensions | ✅ **FETCHED 2026-09-02 — `ElectionsData/sweden/scb_BefolkningNy_2024_municipality_age_sex.json`, mapped to the 29 valkretsar by the statute, `VALKRETS_POPULATION_README.md`** |
