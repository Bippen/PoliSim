...
## Part B — Parliament (MASTER SEQUENCE STEPS 4 and 5; step 4 DONE, step 5 plan REVISED 2026-07-31, 5a/5b/5c/5d DONE, 5e IN PROGRESS - Phases A and B DONE, Phase C batches 1-3 DONE, batches 4+ remain, scope now combined with 5f)
...
**Batches 4+ — remaining tab content: NOT STARTED.** Left: **Policy/Laws** (5 sub-categories) and
**Tax/Spending** (the shared Budget Process screen). Budget Process is the natural LAST batch: it is the
biggest screen, and `StandingDraftPair`/`DraftTrack` were designed for its line items specifically —
though per the SupportBar lesson above, verify they match the real draft/standing model before use.
