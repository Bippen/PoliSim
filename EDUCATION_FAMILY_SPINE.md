...
"Billed" and "absent" print as words in the caption face, never as figures (the rows printed "to fetch" until §373, when they were closed as billed). Nothing here is built; the board corrects it, then the pass builds what the board says.
