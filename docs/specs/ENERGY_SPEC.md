...
| **The sector dials' cost (P4-B3)** | Energy's dials would now cost through the ledgers | reconciled at stage 5 (EN-7a, §498): the Energy subsidy's cost is the energy line's move, the figure the Sectors screen prints is what the line carries; SC-1 - the other dials' cost, which landed on no line in five books - RULED and BUILT (§503, §504): on each statute budget's Business-and-industry line (the USA's Commerce, Germany's Energy subsidy with it), outside the line's seed band, a line held at zero |
...
| 5 | policy and laws: the five dials mapped onto the instruments, the ONE law category reaching the energy parameters - **its own item, cited (§378 ruled 2026-09-12, §474: "the wider dials-only set follows P4-C3's one-category-per-session pattern and does not block stage 5")** - **the dials LANDED 2026-09-14 (EN-7a, `COMPLETED.md` §498); the law category LANDED 2026-09-15 (EN-7b, §500) - stage 5 complete** | **2** | stage 4 (landed); EN-7 |
